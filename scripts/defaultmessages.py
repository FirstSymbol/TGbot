...
def LoadPradnikGlobal(bot:TeleBot,message:Message):
    bot.edit_message_text(text='1. День Конституции – 15 марта;\n' +
                               ...
                               '3. День Победы – 9 мая;\n' +
                               '4. День Государственного флага, Государственного герба и Государственного гимна Республики Беларусь – второе воскресенье мая;\n' +
                               '5. День Независимости Республики Беларусь (День Республики) – 3 июля\n' +
                               '6. День народного единства – 17 сентября.',
                          chat_id=message.chat.id,
                          message_id=message.message_id,
